...
type = localStorage.getItem('type')
  ...
  loginToken = undefined; // used to identify if succesfully logged in
  //#endregion
  innerHeight: string;
  windowWidth: number;
...
/*  @ViewChild('toggleButton') toggle_button: ElementRef;
  ...
  constructor(public menuItems: MenuItems,private router: Router,private loginService:LoginService) {
    this.navType = 'st2';
